rpg : main.o Character.o Mage.o Barbarian.o Exceptions.o Potion.o Monstre.o
	g++ main.o Character.o Mage.o Barbarian.o Exceptions.o Potion.o Monstre.o -o rpg
